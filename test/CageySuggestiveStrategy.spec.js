...
describe('CageySuggestiveStrategy', function () {
    ...
    describe('strategy', function () {
        it('never chooses from its own hand', function () {
            ...
            const strategy = new CageySuggestiveStrategy(hand, deck, game_summary);
        ...
        it('sees when another player shows it a card', function () {
            ...
            const strategy = new CageySuggestiveStrategy(hand1, deck, game_summary);
            ...
            // CageySuggestiveStrategy isn't smart enough to know that it did not
        ...
        it('figures out what card was shown', function () {
            ...
            // Since CageySuggestiveStrategy knows what cards it has, it can infer
        ...
        it('figures out what card was shown by remembering suggestion', function () {
            ...
            // CageySuggestiveStrategy does not have enough information to infer
